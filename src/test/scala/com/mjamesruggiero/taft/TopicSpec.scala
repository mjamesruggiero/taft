...
class TopicSpec extends FlatSpec with Matchers {
  ...
  "tfidf" should "calculate the product of tf and if" in {
    val doc1 = """Python is a 2000 made-for-TV horror movie directed by Richard
    ...
    II (2002) and Boa vs. Python (2004), both also made-for-TV films.""".split("\\s+").toList

    val doc2 = """Python, from the Greek word (πύθων/πύθωνας), is a genus of
    nonvenomous pythons[2] found in Africa and Asia. Currently, 7 species are
    recognised.[2] A member of this genus, P. reticulatus, is among the longest
    snakes known.""".split("\\s+").toList

    val doc3 = """The Colt Python is a .357 Magnum caliber revolver formerly
    ...
    finest production revolver ever made.""".split("\\s+").toList
